    ...
    public partial class EmployeeForm : Form
    {
        ...
        private void RemoveEmployeeButton_Click(object sender, EventArgs e)
        {
            ...
            if (parts.Length >= 2)
            {
                ...
                var employeeToRemove = employeeManager.Employees.Find(em => em.Name == name && em.Position == position);
        ...
        private void UpdateVacationButton_Click(object sender, EventArgs e)
        {
            ...
            if (parts.Length >= 2)
            {
                string name = parts[0].Trim();
                string position = parts[1].Trim();
                var employeeToUpdate = employeeManager.Employees.Find(em => em.Name == name && em.Position == position);
